...
def get_args_parser():
    ...
    ## diffusion arch
    parser.add_argument("--timesteps", type=int, default=1000, help='number of diffusion tiemesteps')
    parser.add_argument("--objective", "-obj", type=str, default="pred_noise", choices = ['pred_noise', 'pred_x0', 'pred_v'], help='diffusion objective')
    parser.add_argument("--beta-schedule", type=str, default='cosine', help='beta schedule')
    parser.add_argument("--ddim-eta", "-eta", type=float, default=0., help='eta for ddim-sampler')
    
    ## quantizer
    parser.add_argument("--quantizer", type=str, default='ema_reset', choices = ['ema', 'orig', 'ema_reset', 'reset', 'residual'], help="eps for optimal transport")
    parser.add_argument("--num-quantizers", type=int, default=4, help="number of quantizers")
    ...
    parser.add_argument("--resume-trans", type=str, default=None, help='resume gpt and diffusion pth')
