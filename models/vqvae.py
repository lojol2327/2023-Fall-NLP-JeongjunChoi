...
class VQVAE_251(nn.Module):
    def __init__(self,
        ...
        elif args.quantizer == "residual":
            self.quantizer = ResidualVQ(dim=code_dim,
    ...
    def encode(self, x):
        ...
        print('zzzzzzz x.shape: ', x.shape, 'zzzzzzz')
    ...
    def forward(self, x):
        ...
        ## quantization
        # Actually x_quantized is dequantized variable before entering decoder
        x_quantized, loss, perplexity = self.quantizer(x_encoder)
        'x_quantized -> 256 512 16'
        ## decoder
        x_decoder = self.decoder(x_quantized)
        'x_decoder -> 256 263 64'
